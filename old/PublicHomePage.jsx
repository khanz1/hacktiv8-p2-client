  ...
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-2 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          {posts.map((movie) => (
            <div
              key={movie.id}
              className="relative min-h-[400px] w-72 rounded-md ring-1 ring-slate-200 overflow-hidden"
            >
              <img src={movie.imgUrl} className="absolute w-full" />
              <div className="flex max-w-xl flex-col items-start justify-end h-full p-2 relative z-10 bg-gradient-to-b from-transparent to-slate-200 hover:to-slate-100">
